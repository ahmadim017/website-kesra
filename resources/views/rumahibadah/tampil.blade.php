    ...
    <div class="" style="height:200px;">
      <div class="flex flex-wrap justify-center text-center py-14">
        <div class="w-full px-4">
          <h1 class="text-4xl font-bold text-white" style="font-family: 'Quicksand', sans-serif;">Data Sarana Keagamaan</h1>
        </div>
      </div>
    </div>
  </div>
      ...
      <nav class="flex" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
          ...
          <li>
              ...
              <a href="#" class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">Data Sarana Keagamaan</a>
              </div>
          </li>
        ...
        <section>
            <div class="container mx-auto m-8" style="font-family: 'Quicksand', sans-serif;">
                <div class="mb-5">
                    ...
                    <form action="{{route('rumahibadah.tampil')}}" >
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="py-4 px-6">
                                   <a href="#" class="text-emerald-600" data-modal-toggle="defaultModal-{{$r->id}}">{{$r->namasarana}}</a> 
                                </td>
                                <td class="py-4 px-6">
                                    @if ($r->jenis == 'Masjid')
                                    <span class="bg-emerald-600 text-white font-semibold  px-3 py-1 text-sm rounded-xl">Masjid</span>
                                    @else
                                    <span class="bg-gray-700 text-white font-semibold  px-3 py-1 text-sm rounded-xl">Mushola</span>
                                    @endif
            ...
            <div class="p-6 space-y-6">
                <dl class="max-w-md text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                    <div class="flex flex-col pb-3">
                        <dt class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Nomor Ijin</dt>
                        <dd class="text-lg font-semibold">{{$r->nomorijin}}</dd>
                    </div>
                    <div class="flex flex-col py-3">
                        <dt class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Jenis Sarana</dt>
                        <dd class="text-lg font-semibold">{{$r->jenis}}</dd>
                    </div>
                    <div class="flex flex-col py-3">
                        <dt class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Pimpinan</dt>
                        <dd class="text-lg font-semibold">{{$r->pimpinan}}</dd>
                    </div>
                    <div class="flex flex-col py-3">
