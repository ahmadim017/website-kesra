...
<div class="row">
    ...
    <a href="{{route('opd.create')}}" class="d-none d-sm-inline-block btn btn-info btn-sm shadow-sm"><i class="fa fa-plus-circle fa-sm text-white-50"></i> Tambah Dinas</a>
    </div> 
</div><br>
...
<table class="table table-striped" id="dataTable">
    ...
    <tbody>
      ...
      <tr>
          ...
          <td><a href="{{route('opd.edit',[$o->id])}}" class="btn btn-info btn-sm">Edit</a> 
          </form>
            </td>
      </tr>
      @endforeach
